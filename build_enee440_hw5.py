...
sys_tick_S = blueprint.Blueprint(
  name = source_dir + "sys_tick.S",
  builder = collect,
  materials = [],
  foundation = []
)
...
initSYSCLK_S = blueprint.Blueprint(
  name = resource_dir + "initSYSCLK.S",
  builder = collect,
  materials = [],
  foundation = []
)
initSysTick_S = blueprint.Blueprint(
  name = resource_dir + "initSysTick.S",
  builder = collect,
  materials = [],
  foundation = []
)
...
initSYSCLK_o = blueprint.Blueprint(
  name = binary_dir + "initSYSCLK.o",
  builder = build,
  materials = [initSYSCLK_S],
  foundation = [initSYSCLK_S]
)
initSysTick_o = blueprint.Blueprint(
  name = binary_dir + "initSysTick.o",
  builder = build,
  materials = [initSysTick_S],
  foundation = [initSysTick_S]
)
...
sys_tick_o = blueprint.Blueprint(
  name = binary_dir + "sys_tick.o",
  builder = build,
  materials = [sys_tick_S],
  foundation = [sys_tick_S]
)
main_o = blueprint.Blueprint(
  name = binary_dir + "main.o",
  builder = build,
  materials = [main_c],
  foundation = [main_c, led_driver_h, sys_tick_h]
)

blinky_elf = blueprint.Blueprint(
  name = binary_dir + "blinky.elf",
  builder = link,
  materials = [main_o, sys_tick_o, led_driver_o, button_driver_o,
               stm32f767xx_boot_o, stm32f767xx_reset_o,
               initSYSCLK_o, initSysTick_o],
  foundation = [main_o, sys_tick_o, led_driver_o, button_driver_o,
                stm32f767xx_boot_o, stm32f767xx_reset_o,
                initSYSCLK_o, initSysTick_o]
)
